...
2. **The recurring case is a "shipped" comment**, posted right after moving an issue to Done (see `workflows/linear/update-issue.md` step 7). Use this template, adapting to what actually happened:
