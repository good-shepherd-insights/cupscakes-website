...
import type { CustomOption, CustomOptionWithImageUrl, Product } from '../../types/product';
...
export function resolveCustomOptionImages(customOptions: CustomOption[], width: number): CustomOptionWithImageUrl[] {
